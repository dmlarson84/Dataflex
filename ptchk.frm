...
/LETTER_BODY
     ______________________________ _____ __/__/__  _____.__  __.__
/LETTER_END
...
บ                                                                   บ
บ                                                                   บ
บ   The system shows a disburse date of .........{ __/__/__         บ
...
Dispdt..: __/__/__    Dispamt..: _____.__    Manual..: _    Chkno..: _____.
...
//            [err] begin
//              output doerr
//              display Disburse.recnum to warn3.1
//              display setup.recnum to warn3.2
//              display defendnt.recnum to warn3.3
//              display offense.recnum to warn3.4
//              Page warn3
//                 Repeat
//                    Accept warn3.6
//                    uppercase warn3.6
//                      if ~ warn3.6 in "QR" loop
//                      if warn3.6 eq "Q" Abort
//
//            End
...
[~ PASS2]   BEGIN
            ...
            MOVE (0.00) TO ACCUM_2
            [~ PASS3] if prosecutor_total gt (0) OUTPUT SUBTOTAL1
         END
            MOVE (0.00) TO ACCUM_2
REPORTEND
