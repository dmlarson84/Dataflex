...
//	ENTRY RESTITUT.IDNO					 {NOPUT}
	...
	accept REDIT				{CAPSLOCK,CHECK='YN'} 
//	RELATE DEFENDNT
	reread restitut
	reread defendnt
...
//	move restitut.idno to rid			 
// If this doesn't work try moving it to rest.21 instead.
	
//	ENTRY RESTITUT.IDNO                  {NOENTER}
//    ENTRY RESTITUT.SEQNO                 {AUTOFIND}	 //SKIPFOUND??	// I don't think I need the NOENTER here, it should bounce them back to start properly as-is

//	[finderr] clearform rdt thru rmethod		// maybe clearform the entire restitution section on failure to find instead?
